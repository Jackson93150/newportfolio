      ...
      <group name="Scene">
        <group name="Armature" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
          ...
          <group name="Aviators_Transparent_0">
            ...
            <skinnedMesh name="Aviators_Transparent_0001_1" geometry={nodes.Aviators_Transparent_0001_1.geometry} material={materials['Glass_tinted.001']} skeleton={nodes.Aviators_Transparent_0001_1.skeleton} transparent opacity={0}/>
